...
public class WebViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ASWP_LOCATION && !check_permission(1)) {
            ActivityCompat.requestPermissions(WebViewActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, loc_perm);
        }
        ...
        if (share != null) {
            ...
            Toast.makeText(WebViewActivity.this, share_img, Toast.LENGTH_LONG).show();
    ...
    public void onResume() {
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            Bitmap bm = BitmapFactory.decodeResource(getResources(), R.drawable.fghddfhdfgjhjjfg);
            ActivityManager.TaskDescription taskDesc;
            taskDesc = new ActivityManager.TaskDescription(getString(R.string.app_name), bm, getColor(R.color.colorPrimary));
            WebViewActivity.this.setTaskDescription(taskDesc);
        }
    ...
    private class Callback extends WebViewClient {
        ...
        public void onPageFinished(WebView view, String url) {
            ...
            if (!url.contains("error")) {
                ...
                if (pref.getInt("num", 0) == 1) {
                    pref.edit()
                            .putString("links", url)
                            .putInt("num", -100000)
                            .apply();
                } else {
                    pref.edit().putInt("num", pref.getInt("num", 0) + 1).apply();
                }
    ...
    public boolean url_actions(WebView view, String url) {
        ...
        if (!ASWP_OFFLINE && !isInternetAvailable()) {
